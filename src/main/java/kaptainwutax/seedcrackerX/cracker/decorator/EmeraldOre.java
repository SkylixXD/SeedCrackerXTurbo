...
public class EmeraldOre extends Decorator<Decorator.Config, EmeraldOre.Data> {
    ...
    public static final VersionMap<kaptainwutax.seedcrackerX.cracker.decorator.Decorator.Config> CONFIGS = new VersionMap<kaptainwutax.seedcrackerX.cracker.decorator.Decorator.Config>()
    ...
    @Override
    public boolean canStart(kaptainwutax.seedcrackerX.cracker.decorator.EmeraldOre.Data data, long structureSeed, ChunkRand rand) {
